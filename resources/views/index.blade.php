    ...
    <div id="wrapper" style="display: flex;">
        ...
        <div style="overflow: auto; width: 240px; height: 550px; border:"> 
                ...
                <li>
                    ...
                    <a href="/labs/labProcI/2">
                        <i class=""></i>
                        <h3><b>Lab.Processamento II</b></h3>
                    </a>
                </li>
                <br>
                ...
                <li>
                    <a href="/labProIII">
                        <i class=""></i>
                        <h3><b>Lab.Processamento III</b></h3>
                    </a>
                </li>
<br>
                <hr>
                <li>
                    <a href="/labProMec">
                        <i class=""></i>
                        <h3><b>Lab.Propriedades Mecânicas</b></h3>
                    </a>
                </li>
<br>
                <hr>
                <li>
                    <a href="/labPreAmo">
                        <i class=""></i>
                        <h3><b>Lab.Preparação de Amostra</b></h3>
                    </a>
                </li>
                ...
                <li>
                    <a href="/labProFis">
                        <i class=""></i>
                        <h3><b>Lab.Propriedades Físicas</b></h3>
                    </a>
                </li>
                ...
                <hr>
                <li>
                    <a href="/labCienciaPol">
                        <i class=""></i>
                        <h3><b>Lab.Ciência de Polímeros</b></h3>
                    </a>
                </li>
                ...
                <li>
                    <a href="/labCaraQuiI">
                        <i class=""></i>
                        <h3><b>Lab.Caracterização Quimica I</b></h3>
                    </a>
                </li>
                ...
                <li>
                    <a href="/labCaraQuiII">
                        <i class=""></i>
                        <h3><b>Lab.Caracterização Quimica II</b></h3>
                    </a>
                </li>
